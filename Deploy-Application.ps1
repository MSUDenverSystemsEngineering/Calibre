...
Try {
	...
	[string]$appVendor = 'Free Software Foundation'
	[string]$appName = 'Calibre'
	[string]$appVersion = '3.30.0'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-MSI -Action "Uninstall" -Path "{A7D3A0B5-FC41-4C92-BF3E-3064B61CEBB0}" -PassThru
        If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
